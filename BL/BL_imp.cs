...
namespace BL
{
    public class BL_imp : IBL
    {
        ...
        public void addtest(Test x)
        {
            ...
            throw new Exception("the test is added succesfully");
        ...
        {
            if (x.adressnum < 0 || x.adresscity == null || x.adressstreet == null || x.testdate == null || temp.Get_Tester(x.testernum) == null || x.testnum < 0) /////?????????? get house num , testnum <0
